...
* Information about the system such as the number of nodes, resource utilisation, real-time scheduling of tasks, processing of tasks and deployment of containerised services will all be presented by the front-end.
