...
PATH = [
    "./app/object/service.yaml",
    "./app/ocr/service.yaml",
    "./app/extract-info/service.yaml",
    "./app/face-recognition/service.yaml",
    "./app/speech-to-text/service.yaml",
    "./app/fast-text/service.yaml",
    "./app/textgenrnn/service.yaml",
    "./app/SimpleHTR/service.yaml",
    "./app/FaceMaskDetection/service.yaml",
    "./app/extract-table/service.yaml",
    "./app/easy12306/service.yaml",
